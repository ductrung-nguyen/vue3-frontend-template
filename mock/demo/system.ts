...
const deptList = (() => {
  ...
  for (let index = 0; index < 3; index++) {
    result.push({
      id: `${index}`,
      deptName: ['East China Branch', 'South China Division', 'Northwest branch'][index],
      orderNo: index + 1,
      createTime: '@datetime',
      remark: '@cword(10,20)',
      'status|1': ['0', '0', '1'],
...
const menuList = (() => {
  ...
  for (let index = 0; index < 3; index++) {
    result.push({
      ...
      component: 'LAYOUT',
      type: '0',
      menuName: ['Dashboard', 'Authority management', 'Function'][index],
      permission: '',
      orderNo: index + 1,
      createTime: '@datetime',
      'status|1': ['0', '0', '1'],
