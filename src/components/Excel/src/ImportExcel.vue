...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      // Time zone adjustment. Experimental feature, only to solve the problem of reading datetime values with deviations.
      // Currently only offset corrections are provided for the + 08: 00 time zone
    ...
    setup(props, { emit }) {
      ...
      /**
       * @description: Trigger selection of file manager
       */
