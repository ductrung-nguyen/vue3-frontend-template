...
export interface CompensationHeight {
  // Use the layout Footer height as the condition for judging the compensation height
...
/**
 * Dynamically calculate the height of the content, according to the lowest coordinate
 * of the anchor dom to the lowest coordinate of the screen, and dynamically calculate the height,
 * padding, margin, etc. of the incoming dom to finally obtain the appropriate content height
 *
 * @param flag Responsive markup for enabling calculations
 * @param anchorRef Anchor component Ref<ElRef | ComponentRef>
 * @param subtractHeightRefs List of components to subtract height Ref<ElRef | ComponentRef>
 * @param substractSpaceRefs List of components to be subtracted from free space (margins/paddings) Ref<ElRef | ComponentRef>
 * @param offsetHeightRef Calculate the responsive height of the offset, this value will be subtracted directly when calculating the height
 * @param upwardSpace Upward recursion subtracts the level of free space or until the specified class. A value of 2 means upward recursion twice | a value of ant-layout means upward recursion until it meets .ant-layout
